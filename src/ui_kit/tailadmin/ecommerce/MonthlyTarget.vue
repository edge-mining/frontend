<template>
  <div
    class="border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]"
  >
    <div
      class="px-5 pt-5 bg-white shadow-default pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6"
    >
      ...
      <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
        You used 12 kWh today, it's higher than last month. Keep up your good work!
      </p>
    </div>
